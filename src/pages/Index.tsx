    ...
    useEffect(() => {
        const fetchBookings = async () => {
            try {
                ...
                // Filter bookings based on driverId, phone, and password
                const filteredBookings = bookings.filter(booking => {
                    return booking.driverId === driverId && booking.phone === phone && booking.password === password;
                });
                const newBookings = filteredBookings.filter(booking => booking.status === 'booking added').length;
                ...
                const completedBookings = filteredBookings.filter(booking => booking.status === 'Order Completed').length;
